...
def setup_hpc_widgets(self):
    ...
    self.load_settings_button = ttk.Button(config_frame, text="Load Settings", command=self.load_hpc_settings)
    self.load_settings_button.pack(side='left', padx=5)
    
    self.save_settings_button = ttk.Button(config_frame, text="Save Settings", command=self.save_hpc_settings)
